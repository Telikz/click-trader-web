...
export class RemoteReducers {
  ...
  addUpgrade(
    ...
    this.connection.callReducer(
      'add_upgrade',
      __argsBuffer,
      this.setCallReducerFlags.addUpgradeFlags
    );
  }
  ...
  buyUpgrade(upgradeId: number) {
    ...
    this.connection.callReducer(
      'buy_upgrade',
      __argsBuffer,
      this.setCallReducerFlags.buyUpgradeFlags
    );
  }

  onBuyUpgrade(
    callback: (ctx: ReducerEventContext, upgradeId: number) => void
  ) {
  ...
  createStock(
    ...
    this.connection.callReducer(
      'create_stock',
      __argsBuffer,
      this.setCallReducerFlags.createStockFlags
    );
  }
  ...
  createTransaction(stockId: number, amount: bigint, txType: TransactionType) {
    ...
    this.connection.callReducer(
      'create_transaction',
      __argsBuffer,
      this.setCallReducerFlags.createTransactionFlags
    );
  }
  ...
  increaseMoney() {
    this.connection.callReducer(
      'increase_money',
      new Uint8Array(0),
      this.setCallReducerFlags.increaseMoneyFlags
    );
  }
  ...
  removeOnSetName(
    callback: (ctx: ReducerEventContext, username: string) => void
  ) {
  ...
  updatePlayers(args: UpdatePlayersSchedule) {
    ...
    this.connection.callReducer(
      'update_players',
      __argsBuffer,
      this.setCallReducerFlags.updatePlayersFlags
    );
  }

  onUpdatePlayers(
    callback: (ctx: ReducerEventContext, args: UpdatePlayersSchedule) => void
  ) {
    this.connection.onReducer('update_players', callback);
  }

  removeOnUpdatePlayers(
    callback: (ctx: ReducerEventContext, args: UpdatePlayersSchedule) => void
  ) {
  ...
  updateStockPrices(args: StockMarketSchedule) {
    ...
    this.connection.callReducer(
      'update_stock_prices',
      __argsBuffer,
      this.setCallReducerFlags.updateStockPricesFlags
    );
  }

  onUpdateStockPrices(
    callback: (ctx: ReducerEventContext, args: StockMarketSchedule) => void
  ) {
    this.connection.onReducer('update_stock_prices', callback);
  }

  removeOnUpdateStockPrices(
    callback: (ctx: ReducerEventContext, args: StockMarketSchedule) => void
  ) {
  ...
  updateTransactions() {
    this.connection.callReducer(
      'update_transactions',
      new Uint8Array(0),
      this.setCallReducerFlags.updateTransactionsFlags
    );
  }
...
export class RemoteTables {
  ...
  get marketConfig(): MarketConfigTableHandle {
    return new MarketConfigTableHandle(
      this.connection.clientCache.getOrCreateTable<MarketConfig>(
        REMOTE_MODULE.tables.market_config
      )
    );
  }
  ...
  get stock(): StockTableHandle {
    return new StockTableHandle(
      this.connection.clientCache.getOrCreateTable<Stock>(
        REMOTE_MODULE.tables.stock
      )
    );
  }

  get stockMarketSchedule(): StockMarketScheduleTableHandle {
    return new StockMarketScheduleTableHandle(
      this.connection.clientCache.getOrCreateTable<StockMarketSchedule>(
        REMOTE_MODULE.tables.stock_market_schedule
      )
    );
  }

  get transaction(): TransactionTableHandle {
    return new TransactionTableHandle(
      this.connection.clientCache.getOrCreateTable<Transaction>(
        REMOTE_MODULE.tables.transaction
      )
    );
  }

  get updatePlayerSchedule(): UpdatePlayerScheduleTableHandle {
    return new UpdatePlayerScheduleTableHandle(
      this.connection.clientCache.getOrCreateTable<UpdatePlayersSchedule>(
        REMOTE_MODULE.tables.update_player_schedule
      )
    );
  }

  get upgrades(): UpgradesTableHandle {
    return new UpgradesTableHandle(
      this.connection.clientCache.getOrCreateTable<Upgrades>(
        REMOTE_MODULE.tables.upgrades
      )
    );
  }
}
